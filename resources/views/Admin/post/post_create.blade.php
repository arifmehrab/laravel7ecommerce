                ...
                <!--- colum 1 --->
                  <div class="col-md-6">
                      <div class="form-group">
                         ...
                         <input type="text" class="form-control" name="post_title_en" value="{{ old('post_title_en') }}">
                      </div>
                      <!--- Error Message -->
                      @error('post_title_en')
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                       ...
                       <input type="text" class="form-control" name="post_title_bn" value="{{ old('post_title_bn') }}">
                    </div>
                  </div>
                  <!--- Error Message -->
                  @error('post_title_bn')
                ...
                <!--- colum 4 --->
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <img  width="80" height="80" src="#" id="image1" alt="">
                        </select>
                 <!--- Error Message -->
                  @error('post_image')
                  <strong style="color: red;">{{ $message }}</strong>
              ...
              <div class="form-row">
                  <div class="col-12">
                     <textarea name="post_details_en" class="summernote" rows="3">
                         Post English Details write here... {{ old('post_details_en') }}
                     </textarea>
                  </div>
                   <!--- Error Message -->
               ...
               <div class="form-row">
                <div class="col-12">
                   <textarea name="post_details_bn" class="summernote" rows="3">
                       Post Bangla Details write here... {{ old('post_details_bn') }}
                   </textarea>
                </div>
                 <!--- Error Message -->
