            ...
            <form action="{{ route('admin.product.update', $productEdit->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <!--- colum 1 --->
                  <div class="col-md-4">
                      <div class="form-group">
                         ...
                         <input type="text" class="form-control" name="product_name" value="{{ $productEdit->product_name }}">
                      </div>
                      <!--- Error Message -->
                      @error('product_name')
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                       ...
                       <input type="text" class="form-control" name="product_code" value="{{ $productEdit->product_code }}">
                    </div>
                  </div>
                  <!--- Error Message -->
                  @error('product_code')
                ...
                <div class="col-md-4">
                    <div class="form-group">
                       ...
                       <input type="text" class="form-control" name="product_quantity" value="{{ $productEdit->product_quantity }}">
                    </div>
                </div>
              </div><!-- From row end -->
                  ...
                  <div class="col-md-4">
                      <div class="form-group">
                         ...
                         <select class="select2 form-control custom-select" style="width: 100%; height:60px;" name="category" id="category">
                            ...
                            <option {{ ($row->id == $productEdit->category_id)?'selected': '' }} value="{{ $row->id }}">
                                {{ $row->category_name }}
                            </option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <select name="brand" class="select2 form-control custom-select" style="width: 100%; height:60px;">
                            <option>Select</option>
                               ...
                               <option {{ ($row->id == $productEdit->brand_id)?'selected': '' }} value="{{ $row->id }}">
                                 {{ $row->brand_name }}
                               </option>
                               @endforeach
                        </select>
                  ...
                  <div class="col-md-4">
                      <div class="form-group">
                        <label for="">Add Color <strong style="color: red;">*</strong></label><br>
                            <input name="product_color" type="text" class="form-control" value="{{ $productEdit->product_color }}" data-role="tagsinput" placeholder="add Color" style="width: 100%; height:60px;" />
                      </div>
                 <!--- Error Message -->
                  @error('product_color')
                  <strong style="color: red;">{{ $message }}</strong>
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                        <label for="">Add Size <strong style="color: red;">*</strong></label><br>
                            <input name="product_size" type="text" class="form-control" value="{{ $productEdit->product_size }}" data-role="tagsinput" placeholder="add Size" style="width: 100%; height:60px;" />
                    </div>
                <!--- Error Message -->
                  @error('product_size')
                  <strong style="color: red;">{{ $message }}</strong>
                  @enderror
                   ...
                   <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="selling_price" value="{{ $productEdit->selling_price }}">
                    </div>
                  </div>
                   <!--- Error Message -->
                   @error('selling_price')
              ...
              <div class="form-row">
                <div class="col-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="video_link" value="{{ $productEdit->video_link }}">
                    </div>
                </div>
            </div><!-- From row end -->
             ...
             <!-- From section Six -->
                ...
                <!--- colum 12 --->
                  <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <div class="custom-file mb-3">
                            <input name="image1" type="file" class="custom-file-input" id="customFile" onchange="readURL(this)">
                            <label class="custom-file-label form-control" for="customFile">Choose file</label>
                          </div>
                          <img  width="80" height="80" src="{{ asset('Backend/assets/images/product/'.$productEdit->image_one) }}" id="image1" alt="">
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="custom-file mb-3">
                            <input name="image2" type="file" class="custom-file-input" id="customFile" onchange="readURL2(this)">
                            <label class="custom-file-label form-control" for="customFile">Choose file</label>
                          </div>
                          <img width="80" height="80" src="{{ asset('Backend/assets/images/product/'.$productEdit->image_two) }}" id="image2" alt="">
                    <!--- Error Message -->
                   @error('image2')
                   <strong style="color: red;">{{ $message }}</strong>
                   @enderror
                   ...
                   <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="custom-file mb-3">
                            <input name="image3" type="file" class="custom-file-input" id="customFile" onchange="readURL3(this)">
                            <label class="custom-file-label form-control" for="customFile">Choose file</label>
                          </div>
                          <img width="80" height="80" src="{{ asset('Backend/assets/images/product/'.$productEdit->image_three) }}" id="image3" alt="">
                 <!--- Error Message -->
                   @error('image3')
                   <strong style="color: red;">{{ $message }}</strong>
                   @enderror
              ...
              <div class="form-row">
                <!--- colum 15 --->
                  <div class="col-md-4">
                      <div class="form-group">
                        <input name="main_slider" value="1" type="checkbox" id="main_slider" class="filled-in chk-col-purple" {{ ($productEdit->main_slider == 1)?'checked': '' }}>
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                        <input name="hot_deal" value="1" type="checkbox" id="hot_deal" class="filled-in chk-col-purple" {{ ($productEdit->hot_deal == 1)?'checked': '' }}>
                   ...
                   <div class="col-md-4">
                    <div class="form-group">
                        <input name="best_rated" value="1" type="checkbox" id="best_rated" class="filled-in chk-col-purple" {{ ($productEdit->best_rated == 1)?'checked': '' }}>
            ...
            <!-- From section Eight -->
              <div class="form-row">
                <!--- colum 18 --->
                  <div class="col-md-4">
                      <div class="form-group">
                        <input name="mid_slider" value="1" type="checkbox" id="mid_slider" class="filled-in chk-col-purple" {{ ($productEdit->mid_slider == 1)?'checked': '' }}>
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                        <input name="hot_new" value="1" type="checkbox" id="hot_new" class="filled-in chk-col-purple" {{ ($productEdit->hot_new == 1)?'checked': '' }}>
                   ...
                   <div class="col-md-4">
                    <div class="form-group">
                        <input name="trendy" value="1" type="checkbox" id="trendy" class="filled-in chk-col-purple" {{ ($productEdit->trendy == 1)?'checked': '' }}>
...
@push('js')
 <!-- This page plugins -->
          ...
          $(document).on('change','#category', function(){
              ...
              $.ajax({
                  ...
                  success:function(data) {
                    ...
                    var subCategory_id = "{{ @$productEdit->subcategory_id }}";
                    if(subCategory_id != '') {
   ...
   <!----- Subcategory Show By Jquery ---->
   <script type="text/javascript">
    $(document).ready(function(){
        var category_id = "{{ @$productEdit->category_id }}";
        if(category_id) {
